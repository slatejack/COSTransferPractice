...
public class RegisterActivity extends AppCompatActivity{
    ...
    private com.tencent.qcloud.costransferpractice.DBOpenHelper mDBOpenHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDBOpenHelper = new com.tencent.qcloud.costransferpractice.DBOpenHelper(this);

        //将验证码用图片的形式显示出来
        mIvRegisteractivityShowcode.setImageBitmap( com.example.FTPlogin.Code.getInstance().createBitmap());
        realCode = com.example.FTPlogin.Code.getInstance().getCode().toLowerCase();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_registeractivity_back: //返回登录页面
                Intent intent1 = new Intent(this, logintable.class);
